...
\begin{itemize}
    ...
    \item Assume that the benefiial effect of thrombectomy decays to zero in 6 hours \cite{fransen_time_2016}.
...
These steps are shown diagramtically in figure \ref{fig:mt_deaths}.
...
\centering
\begin{tabular}{l | l}
\caption{Estimated treatment-related deaths}\label{tab:treatment_deaths}
