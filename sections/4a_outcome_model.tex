...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\linewidth]{images_modelling/data_sources_nlvo-no-treatment.png}
    \caption{Deriving the predicted mRS distribution for untreated nLVO.}
    \label{fig:data_sources_nlvo-no-treatment}
\end{figure}
