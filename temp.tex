...
% Packages
\usepackage[a4paper, left=2cm, right=2cm, top=2cm, bottom=2.0cm]{geometry}
...
\printbibliography
\end{refsection}
\include{sections/7_other_material}
\include{sections/9_figures}
...
\beginsupplement
%TC:igno
\include{sections/8_supplementarty_material}
%\include{sections/9_background_research}
